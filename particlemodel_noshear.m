...
std_dev = 0.5*width_1std_100_noshear(1)*1000.0; %1 std dev in meters 
mu = 0;
...
ylim([0 60]);
xlim([0 36]);
title('Weak Shear Results')
pbaspect([2 1 1]);
patch([15.5 15.5 25.0 25.0 15.5],[0 120 120 0 0], [0.7 0.7 0.7],'FaceAlpha',0.1);
legend('Weak Shear','Particle Model (domain avg)', 'Particle model (in-plume)','Particle model (plume edge)','Location','southeast')